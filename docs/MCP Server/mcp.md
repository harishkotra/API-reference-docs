...
3. **Ask about AISA** - try questions like:
   * "How do I [common use case]?"
   * "Show me an example of [API functionality]"
   * "Create a [integration type] using AISA"

The AI should now have access to your AISA account data and documentation through the MCP server.